  ...
  return (
    <div className="flex w-full">
      <div className="flex flex-col flex-auto">
        <div className="flex justify-between bg-white shadow-md h-20 items-center p-3">
          <div className="lg:justify-items-end lg:px-10">
          ...
          <div className="justify-items-end">
            <div className="flex items-center">
              <Image
                className="rounded-3xl bg-gray-900"
                ...
                width={50}
              />
              <span className="p-1 text-3xl">{/* <HiChevronDown /> */}</span>
            </div>
          </div>
        </div>
      </div>
